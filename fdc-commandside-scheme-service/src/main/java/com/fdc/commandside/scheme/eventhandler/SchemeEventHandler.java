package com.fdc.commandside.scheme.eventhandler;
...
@Component
public class SchemeEventHandler {

	private static final Logger LOG = LoggerFactory.getLogger(SchemeEventHandler.class);
	...
	public void handle(EmployerCreatedEvent event) {
		LOG.debug("EmployerCreatedEvent processing for corporate customer ID {} and Scheme Id {} ", event.getId(),event.getSchemeId());
